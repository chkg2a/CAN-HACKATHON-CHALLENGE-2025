    ...
    <div className="w-full max-w-2xl mx-auto p-6">
      ...
      {!file ? (
        ...
        >
          ...
          <h3 className="text-lg font-medium mb-2">Drop your document here or click to browse</h3>
          <p className="text-sm text-gray-500 mb-4">Supports PDF and Word documents (.pdf, .doc, .docx)</p>
          <button 
        ...
        <div className="border rounded-lg p-6">
          ...
          <div className="flex items-center p-4 bg-gray-50 rounded-lg">
            ...
            <div className="ml-4">
              ...
              <p className="text-sm text-gray-500">{getFileTypeLabel()} • {(file.size / 1024 / 1024).toFixed(2)} MB</p>
            </div>
          </div>
